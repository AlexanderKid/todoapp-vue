<template>
  <div class="flex min-h-screen bg-gray-100 font-inter">
    <!-- Бічна панель -->
    <aside class="w-64 bg-white p-6 shadow-lg rounded-r-2xl flex flex-col justify-between overflow-y-auto">
      <div>
        <!-- Заголовок меню -->
    ...
    <!-- Модальне вікно для додавання нової нотатки -->
...
body {
  ...
  background-color: #f0f2f5; /* Світло-сірий фон для всієї сторінки */
}
